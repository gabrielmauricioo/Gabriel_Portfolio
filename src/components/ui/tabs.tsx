...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex  items-center justify-center rounded-[30px] bg-white p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
